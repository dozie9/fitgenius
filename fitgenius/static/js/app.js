...
function checkAll(e) {
    ...
    if (e.checked) for (var c = 0; c < t.length; c++) "checkbox" == t[c].type && (t[c].checked = !0); else for (c = 0; c < t.length; c++) "checkbox" == t[c].type && (t[c].checked = !1)
}
...
!function (c) {
    ...
    function l(e) {
        1 == c("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (c("html").removeAttr("dir"), c("#dark-mode-switch").prop("checked", !1), c("#rtl-mode-switch").prop("checked", !1), c("#dark-rtl-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap.min.css"), c("#app-style").attr("href", "../../static/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == c("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (c("html").removeAttr("dir"), c("#light-mode-switch").prop("checked", !1), c("#rtl-mode-switch").prop("checked", !1), c("#dark-rtl-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap-dark.min.css"), c("#app-style").attr("href", "../../static/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == c("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (c("#light-mode-switch").prop("checked", !1), c("#dark-mode-switch").prop("checked", !1), c("#dark-rtl-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap-rtl.min.css"), c("#app-style").attr("href", "../../static/css/app-rtl.min.css"), c("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == c("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (c("#light-mode-switch").prop("checked", !1), c("#rtl-mode-switch").prop("checked", !1), c("#dark-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap-dark-rtl.min.css"), c("#app-style").attr("href", "../../static/css/app-dark-rtl.min.css"), c("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"))
    }
    ...
    c("#side-menu").metisMenu(), c("#vertical-menu-btn").on("click", function (e) {
        ...
        var e;
        0 < c("#sidebar-menu").length && 0 < c("#sidebar-menu .mm-active .active").length && (300 < (e = c("#sidebar-menu .mm-active .active").offset().top) && (e -= 300, c(".vertical-menu .simplebar-content-wrapper").animate({scrollTop: e}, "slow")))
        ...
        if (document.getElementById("topnav-menu-content")) {
            for (var e = document.getElementById("topnav-menu-content").getElementsByTagName("a"), t = 0, c = e.length; t < c; t++) e[t].onclick = function (e) {
